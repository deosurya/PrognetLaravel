...
<body
  background="https://images.pexels.com/photos/428429/pexels-photo-428429.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
  bgproperties="fixed">
          ...
          @csrf
            <div class="col-md-12">
              <div class="form-outline mb-4">
                <input type="text" id="form-nama" name="form-nama" class="form-control" required pattern="[A-Za-z ]+"
                  title="Nama hanya boleh berupa huruf!" />
            ...
            <div class="col-md-6">
              <div class="form-outline mb-4 col-md-4">
                <input type="text" id="form-nim" name="form-nim" class="form-control" required maxlength="10" minlength="10"
                  pattern="[0-9]{10}" title="Nim terdiri dari 10 angka!" />
            ...
            <div class="col-md-6">
              <div class="form-outline mb-4 col-md-4">
                <input type="tel" id="form-telp" name="form-telp" class="form-control" required pattern="[0-9]+"
                  title="Contoh: 08123456789" />
            ...
            <div class="col-md-10 mb-4">
              <div class="mb-2 radio-group">
                <div class="btn-group">
                  <input type="radio" class="btn-check" value="Laki-laki" name="gender" id="gender1" autocomplete="off"
                    required />
                  <label class="btn btn-secondary" for="gender1">Laki-laki</label>

                  <input type="radio" class="btn-check" value="Perempuan" name="gender" id="gender2"
                    autocomplete="off" />
            ...
            <div class="col-md-10 mb-4">
              <div class="mb-2 radio-group">
                <div class="btn-group">
                  <input type="radio" class="btn-check" value="Hindu" name="options" id="option1" autocomplete="off"
                    required />
                  <label class="btn btn-secondary" for="option1">Hindu</label>

                  <input type="radio" class="btn-check" value="Buddha" name="options" id="option2" autocomplete="off" />
                  <label class="btn btn-secondary" for="option2">Buddha</label>

                  <input type="radio" class="btn-check" value="Islam" name="options" id="option3" autocomplete="off" />
                  <label class="btn btn-secondary" for="option3">Islam</label>

                  <input type="radio" class="btn-check" value="Kristen" name="options" id="option4"
                    autocomplete="off" />
                  <label class="btn btn-secondary" for="option4">Kristen</label>

                  <input type="radio" class="btn-check" value="Katholik" name="options" id="option5"
                    autocomplete="off" />
                  <label class="btn btn-secondary" for="option5">Katholik</label>

                  <input type="radio" class="btn-check" value="Konghucu" name="options" id="option6"
                    autocomplete="off" />
            ...
            <div class="col-md-10 mb-4">
              <div class="datepicker-container">
                <input type="date" id="datepicker" name="datepicker" data-mdb-inline="true" disable-future required>
              </div>
            </div>

            <div class="col-12 mt-4 mb-3">
              <div class="form-check">
                <input class="form-check-input" type="checkbox" value="" id="select1" name="select1" required />
                <label class="form-check-label" for="select1">Saya merupakan mahasiswa Universitas Udayana.</label>
              </div>

              <div class="form-check">
                <input class="form-check-input" type="checkbox" value="" id="select2" name="selec2" required />
                <label class="form-check-label" for="select2">Saya setuju dengan kententuan perjanjian pengguna.</label>
              </div>
            </div>
